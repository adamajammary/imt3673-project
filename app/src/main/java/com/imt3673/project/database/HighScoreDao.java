...
public interface HighScoreDao {
    ...
    @Query("SELECT * FROM high_score WHERE level_name LIKE :levelName ORDER BY level_time ASC LIMIT 3")
    List<HighScore> getTopScoresFromLevelSorted(String levelName);
